clc;clear;close all;
theta_z = zeros(1,4);
distance_z = [0 200 200 160];
theta_x = [deg2rad(20) deg2rad(30) deg2rad(40) 0];
distance_x = zeros(1,4);
...
legend([p0 p1 p2 p3 p4],['X_0','X_1','X_2','X_3','X_4'])
grid on;
title('FK');
xlabel('X[mm]')
ylabel('Y[mm]')
